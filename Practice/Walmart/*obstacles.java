...
class Run {
  ...
  public void addObstacleTime(int obstacleTime) {
    ...
    //check obstacletime to not be null or 0 before adding it
    obstacleTimes.add(obstacleTime);
    //System.out.println("check time"+obstacleTimes.size());
   // System.out.println("check count"+course.obstacleCount);
   //  System.out.println("\n");
  ...
  public int getRunTime() {
    ...
    //System.out.println("runtime"+ obstacleTimes);
...
class RunCollection {
  ...
  public int personalBest() {
    ...
    //bug is here fixed with filter now
